...
- Moved potion drop chance into `Potion.drop_chance` and removed separate potion
 drop table.
- Reworked potion inventory to store `Potion` objects (with quantity) instead of
 raw ints.
- Updated room roll checks to explicit boundary-based percentages.
- Refreshed `README.md` to a standard structured format.
- Updated docstrings in `main/game_data.py`, `main/player.py`, and `main/main.py`
 for Sphinx/Napoleon rendering.
...
- Potion inventory now uses normalized internal IDs with display labels for
 cleaner command parsing.
- Potion drop table and treasure-room potion messages now use shared potion
 label mapping.
...
- Combat balance tuned with adjusted monster damage, potion healing values, and
 post-fight recovery.
...
- Independent potion drop chances in treasure rooms (multiple potion types can
 drop in one room).
...
- Game-over handling now runs in `main.py` after each command and exits when HP
 reaches 0.
...
- Expanded room-entry flow for empty rooms, including stay/leave prompt and
 follow-up outcomes.
...
[v1.1.2]: https://github.com/python-neo/dungeon-dice/compare/v1.1.1...HEAD
[v1.1.1]: https://github.com/python-neo/dungeon-dice/compare/v1.1.0...v1.1.1
[v1.1.0]: https://github.com/python-neo/dungeon-dice/compare/v1.0.0...v1.1.0
[v1.0.0]: https://github.com/python-neo/dungeon-dice/compare/v0.5.0...v1.0.0
[v0.5.0]: https://github.com/python-neo/dungeon-dice/compare/v0.4.0...v0.5.0
[v0.4.0]: https://github.com/python-neo/dungeon-dice/compare/v0.3.0...v0.4.0
[v0.3.0]: https://github.com/python-neo/dungeon-dice/compare/v0.2.0...v0.3.0
[v0.2.0]: https://github.com/python-neo/dungeon-dice/compare/v0.1.0...v0.2.0
[v0.1.0]: https://github.com/python-neo/dungeon-dice/compare/f7461a048abc9313b0610fef8a601eb0bc4599e3...v0.1.0
